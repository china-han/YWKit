...
//  Copyright © 2018年 yzy. All rights reserved.
//
...
- (void)updateBadgeValueAnimated:(BOOL)animated {
    ...
    // 动画时间
    NSTimeInterval duration = animated ? 0.2 : 0; [UIView animateWithDuration:duration animations:^{
...
- (BOOL)shouldAnimateBadge {
    NSNumber *number = objc_getAssociatedObject(self, &shouldAnimateBadgeKey); return number.boolValue;
}
